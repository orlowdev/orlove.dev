...
export type FileFieldsEnum = 
  ...
  | 'childMarkdownRemark___frontmatter___song'
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  song?: Maybe<StringQueryOperatorInput>;
...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___lineNumbers'
...
export type SitePluginFieldsEnum = 
  ...
  | 'pluginOptions___plugins___pluginOptions___lineNumbers'
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  lineNumbers?: Maybe<BooleanQueryOperatorInput>;
...
export type FixedImagesQuery = { defaultImage?: Maybe<{ sharp?: Maybe<OpenGraphImageFragment> }> };

export type PostPreviewImageFragment = { fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> };

export type OpenGraphImageFragment = { fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> };

export type DisplayImageFragment = { fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> };

export type PostPageFragment = (
  Pick<MarkdownRemark, 'html'>
  & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<(
    Pick<MarkdownRemarkFrontmatter, 'title' | 'song' | 'tags' | 'description' | 'imageAlt'>
    & { image?: Maybe<{ sharp?: Maybe<(
        DisplayImageFragment
        & OpenGraphImageFragment
      )> }> }
  )> }
);
...
export type PostPreviewFragment = (
  ...
  & { frontmatter?: Maybe<(
    Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'description' | 'imageAlt' | 'tags'>
    & { image?: Maybe<{ sharp?: Maybe<PostPreviewImageFragment> }> }
...
export type PageContentsQuery = { markdownRemark?: Maybe<PostPageFragment> };
...
export type TagsContentQuery = { allMarkdownRemark: { edges: Array<{ node: PostPreviewFragment }> } };
